...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class ElementPropertyFilter : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The key property</summary>
        public global::Soenneker.PostHog.OpenApiClient.Models.Key10? Key { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter.ElementPropertyFilter_value? Value { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter.ElementPropertyFilter_value Value { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter();
        }
        /// <summary>
        ...
        public partial class ElementPropertyFilter_value : IComposedTypeWrapper, IParsable
        {
            ...
            /// <summary>Composed type representation for type List&lt;global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter_valueMember1&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter.ElementPropertyFilter_value"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter.ElementPropertyFilter_value CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter.ElementPropertyFilter_value();
                ...
                else if(parseNode.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter_valueMember1>(global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter_valueMember1.CreateFromDiscriminatorValue)?.AsList() is List<global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter_valueMember1> elementPropertyFilterValueMember1Value)
                {
