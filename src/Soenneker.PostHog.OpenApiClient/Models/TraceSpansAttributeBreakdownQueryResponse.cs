...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class TraceSpansAttributeBreakdownQueryResponse : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Result rows for the comparison period when `compareFilter.compare` is true.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow>? Compare { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow> Compare { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow> Results { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponseWarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponseWarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "compare", n => { Compare = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow>(global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "results", n => { Results = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow>(global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponseWarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponseWarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow>("compare", Compare);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.AttributeBreakdownRow>("results", Results);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansAttributeBreakdownQueryResponseWarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
