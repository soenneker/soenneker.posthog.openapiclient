...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter.DataWarehousePersonPropertyFilter_value? Value { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter.DataWarehousePersonPropertyFilter_value Value { get; set; }
#endif
        ...
        public partial class DataWarehousePersonPropertyFilter_value : IComposedTypeWrapper, IParsable
        {
            ...
            /// <summary>Composed type representation for type List&lt;global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter_valueMember1&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter.DataWarehousePersonPropertyFilter_value"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter.DataWarehousePersonPropertyFilter_value CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter.DataWarehousePersonPropertyFilter_value();
                ...
                else if(parseNode.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter_valueMember1>(global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter_valueMember1.CreateFromDiscriminatorValue)?.AsList() is List<global::Soenneker.PostHog.OpenApiClient.Models.DataWarehousePersonPropertyFilter_valueMember1> dataWarehousePersonPropertyFilterValueMember1Value)
                {
