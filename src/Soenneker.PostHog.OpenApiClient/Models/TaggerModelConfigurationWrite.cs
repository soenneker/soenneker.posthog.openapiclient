...
#nullable restore
        ...
        public string Model { get; set; }
#endif
        /// <summary>LLM provider to use for this tagger.* `openai` - Openai* `anthropic` - Anthropic* `gemini` - Gemini* `openrouter` - Openrouter* `fireworks` - Fireworks* `azure_openai` - Azure OpenAI* `together_ai` - Together AI</summary>
