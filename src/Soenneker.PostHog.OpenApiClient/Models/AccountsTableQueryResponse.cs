...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class AccountsTableQueryResponse : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseMetricsResults? MetricsResults { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseMetricsResults MetricsResults { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseWarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseWarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        public static global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "metricsResults", n => { MetricsResults = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseMetricsResults>(global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseMetricsResults.CreateFromDiscriminatorValue); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseWarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseWarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseMetricsResults>("metricsResults", MetricsResults);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.AccountsTableQueryResponseWarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
