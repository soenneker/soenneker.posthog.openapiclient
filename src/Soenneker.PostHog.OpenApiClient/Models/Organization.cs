...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method? DefaultExperimentStatsMethod { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method DefaultExperimentStatsMethod { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Organization_projects>? Projects { get; private set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Organization_projects> Projects { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Organization_teams>? Teams { get; private set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Organization_teams> Teams { get; private set; }
#endif
        ...
        public static global::Soenneker.PostHog.OpenApiClient.Models.Organization CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.Organization();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "default_experiment_stats_method", n => { DefaultExperimentStatsMethod = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method>(global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method.CreateFromDiscriminatorValue); } },
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.Organization_metadata>(global::Soenneker.PostHog.OpenApiClient.Models.Organization_metadata.CreateFromDiscriminatorValue); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "plugins_access_level", n => { PluginsAccessLevel = n.GetIntValue(); } },
                { "projects", n => { Projects = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Organization_projects>(global::Soenneker.PostHog.OpenApiClient.Models.Organization_projects.CreateFromDiscriminatorValue)?.AsList(); } },
                { "slug", n => { Slug = n.GetStringValue(); } },
                { "teams", n => { Teams = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Organization_teams>(global::Soenneker.PostHog.OpenApiClient.Models.Organization_teams.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method>("default_experiment_stats_method", DefaultExperimentStatsMethod);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.Organization.Organization_default_experiment_stats_method CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
