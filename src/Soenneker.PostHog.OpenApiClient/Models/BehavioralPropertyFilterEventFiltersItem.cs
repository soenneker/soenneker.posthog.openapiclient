...
{
    /// <summary>
    /// Composed type wrapper for classes <see cref="global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter"/>, <see cref="global::Soenneker.PostHog.OpenApiClient.Models.EventPropertyFilter"/>, <see cref="global::Soenneker.PostHog.OpenApiClient.Models.FeaturePropertyFilter"/>, <see cref="global::Soenneker.PostHog.OpenApiClient.Models.HogQlPropertyFilter"/>, <see cref="global::Soenneker.PostHog.OpenApiClient.Models.PersonPropertyFilter"/>
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class BehavioralPropertyFilterEventFiltersItem : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.BehavioralPropertyFilterEventFiltersItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.BehavioralPropertyFilterEventFiltersItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.PostHog.OpenApiClient.Models.BehavioralPropertyFilterEventFiltersItem();
        ...
        {
            if(ElementPropertyFilter != null || EventPropertyFilter != null || FeaturePropertyFilter != null || HogQlPropertyFilter != null || PersonPropertyFilter != null)
            {
                return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(ElementPropertyFilter, EventPropertyFilter, FeaturePropertyFilter, HogQlPropertyFilter, PersonPropertyFilter);
            }
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ElementPropertyFilter>(null, ElementPropertyFilter, EventPropertyFilter, FeaturePropertyFilter, HogQlPropertyFilter, PersonPropertyFilter);
        }
    }
}
