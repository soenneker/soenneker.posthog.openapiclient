...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class BulkDeleteDeletedItem : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Variant key when a multivariate flag was fully rolled out to a single variant; otherwise null.</summary>
...
#nullable restore
        ...
        /// <summary>ID of the soft-deleted flag.</summary>
        public int? Id { get; set; }
        /// <summary>The flag key at the time of deletion.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.BulkDeleteDeletedItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.BulkDeleteDeletedItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.BulkDeleteDeletedItem();
        }
        /// <summary>
