...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class ExperimentFunnelsQuery_response : IAdditionalDataHolder, IParsable
...
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_credible_intervals? CredibleIntervals { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_credible_intervals CredibleIntervals { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_funnels_query? FunnelsQuery { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_funnels_query FunnelsQuery { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_kind? Kind { get; set; }
        /// <summary>The probability property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_probability? Probability { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_probability Probability { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_stats_version? StatsVersion { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_stats_version StatsVersion { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        public ExperimentFunnelsQuery_response()
        {
            AdditionalData = new Dictionary<string, object>();
            Kind = global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_kind.ExperimentFunnelsQuery;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "credible_intervals", n => { CredibleIntervals = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_credible_intervals>(global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_credible_intervals.CreateFromDiscriminatorValue); } },
                { "expected_loss", n => { ExpectedLoss = n.GetDoubleValue(); } },
                { "funnels_query", n => { FunnelsQuery = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_funnels_query>(global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_funnels_query.CreateFromDiscriminatorValue); } },
                { "insight", n => { Insight = n.GetObjectValue<UntypedNode>(UntypedNode.CreateFromDiscriminatorValue); } },
                { "kind", n => { Kind = n.GetEnumValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_kind>(); } },
                { "probability", n => { Probability = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_probability>(global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_probability.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_credible_intervals>("credible_intervals", CredibleIntervals);
            writer.WriteDoubleValue("expected_loss", ExpectedLoss);
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_funnels_query>("funnels_query", FunnelsQuery);
            writer.WriteObjectValue<UntypedNode>("insight", Insight);
            writer.WriteEnumValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_kind>("kind", Kind);
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ExperimentFunnelsQuery_response_probability>("probability", Probability);
