...
{
    /// <summary>
    /// Composed type wrapper for classes <see cref="global::Soenneker.PostHog.OpenApiClient.Models.AutonomyPriorityEnumWrapper5"/>, <see cref="global::Soenneker.PostHog.OpenApiClient.Models.BlankEnumWrapper32"/>, <see cref="global::Soenneker.PostHog.OpenApiClient.Models.NullEnum"/>
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SignalUserAutonomyConfigSlackNotificationMinPriority : IComposedTypeWrapper, IParsable
    {
        /// <summary>Composed type representation for type <see cref="global::Soenneker.PostHog.OpenApiClient.Models.AutonomyPriorityEnumWrapper5"/></summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.SignalUserAutonomyConfigSlackNotificationMinPriority"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.SignalUserAutonomyConfigSlackNotificationMinPriority CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
            var result = new global::Soenneker.PostHog.OpenApiClient.Models.SignalUserAutonomyConfigSlackNotificationMinPriority();
            if("AutonomyPriorityEnumWrapper5".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
            {
                result.AutonomyPriorityEnumWrapper5 = new global::Soenneker.PostHog.OpenApiClient.Models.AutonomyPriorityEnumWrapper5();
            }
            else if("BlankEnumWrapper32".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
            {
        ...
        {
            if(AutonomyPriorityEnumWrapper5 != null)
            {
                return AutonomyPriorityEnumWrapper5.GetFieldDeserializers();
            }
            else if(BlankEnumWrapper32 != null)
            {
