...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class NotebookSqlv2RunStatusResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Why the run failed when it never produced an envelope (dispatch or watchdog failure); execution errors arrive inside the envelope&apos;s error field instead.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Models.NotebookSqlv2RunStatusResponse"/> and sets the default values.
        /// </summary>
        public NotebookSqlv2RunStatusResponse()
        {
        ...
        public static global::Soenneker.PostHog.OpenApiClient.Models.NotebookSqlv2RunStatusResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.NotebookSqlv2RunStatusResponse();
        }
        /// <summary>
