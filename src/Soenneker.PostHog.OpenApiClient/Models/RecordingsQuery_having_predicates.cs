...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class RecordingsQuery_having_predicates : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value>? Value { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value> Value { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates"/> and sets the default values.
        /// </summary>
        public RecordingsQuery_having_predicates()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "value", n => { Value = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value>(global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value>("value", Value);
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RecordingsQuery_having_predicates_value : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.PostHog.OpenApiClient.Models.RecordingsQuery_having_predicates.RecordingsQuery_having_predicates_value();
