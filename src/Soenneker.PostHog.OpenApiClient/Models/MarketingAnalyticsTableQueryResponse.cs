...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class MarketingAnalyticsTableQueryResponse : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The columns property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseColumnsItem>? Columns { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseColumnsItem> Columns { get; set; }
#endif
        /// <summary>ISO timestamp of the oldest precompute window backing this result — surfaced as &quot;data as of X&quot;.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? DataComputedAt { get; set; }
#nullable restore
#else
        public string DataComputedAt { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>True when a conversion goal&apos;s precompute has not been warmed for this window yet — the UI shows a &quot;computing&quot; state rather than empty results. Marketing analytics serves exclusively from precompute.</summary>
        public bool? PrecomputeNotReady { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseTypesItem>? Types { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseTypesItem> Types { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseWarningsItem>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseWarningsItem> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseColumnsItem>(global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseColumnsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "dataComputedAt", n => { DataComputedAt = n.GetStringValue(); } },
                ...
                { "precomputeNotReady", n => { PrecomputeNotReady = n.GetBoolValue(); } },
                ...
                { "types", n => { Types = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseTypesItem>(global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseTypesItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseWarningsItem>(global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseWarningsItem.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseColumnsItem>("columns", Columns);
            writer.WriteStringValue("dataComputedAt", DataComputedAt);
            ...
            writer.WriteBoolValue("precomputeNotReady", PrecomputeNotReady);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseTypesItem>("types", Types);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsTableQueryResponseWarningsItem>("warnings", Warnings);
        }
    }
}
