...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17CredibleIntervalsProperty? CredibleIntervals { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17CredibleIntervalsProperty CredibleIntervals { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17InsightItemProperty>? Insight { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17InsightItemProperty> Insight { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17ProbabilityProperty? Probability { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17ProbabilityProperty Probability { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "credible_intervals", n => { CredibleIntervals = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17CredibleIntervalsProperty>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17CredibleIntervalsProperty.CreateFromDiscriminatorValue); } },
                ...
                { "insight", n => { Insight = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17InsightItemProperty>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17InsightItemProperty.CreateFromDiscriminatorValue)?.AsList(); } },
                { "kind", n => { Kind = n.GetStringValue(); } },
                { "p_value", n => { PValue = n.GetDoubleValue(); } },
                { "probability", n => { Probability = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17ProbabilityProperty>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17ProbabilityProperty.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17CredibleIntervalsProperty>("credible_intervals", CredibleIntervals);
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.TrendsQuery>("exposure_query", ExposureQuery);
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17InsightItemProperty>("insight", Insight);
            writer.WriteStringValue("kind", Kind);
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative17ProbabilityProperty>("probability", Probability);
