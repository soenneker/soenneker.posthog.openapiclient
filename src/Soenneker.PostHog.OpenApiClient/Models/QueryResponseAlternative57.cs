...
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57ColumnsItem>? Columns { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57ColumnsItem> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57MetricsResults? MetricsResults { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57MetricsResults MetricsResults { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57WarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57WarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57ColumnsItem>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57ColumnsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "error", n => { Error = n.GetStringValue(); } },
                { "hasMore", n => { HasMore = n.GetBoolValue(); } },
                { "hogql", n => { Hogql = n.GetStringValue(); } },
                { "kind", n => { Kind = n.GetStringValue(); } },
                { "limit", n => { Limit = n.GetIntValue(); } },
                { "metricsResults", n => { MetricsResults = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57MetricsResults>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57MetricsResults.CreateFromDiscriminatorValue); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57WarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57WarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57ColumnsItem>("columns", Columns);
            writer.WriteStringValue("error", Error);
            writer.WriteBoolValue("hasMore", HasMore);
            writer.WriteStringValue("hogql", Hogql);
            writer.WriteStringValue("kind", Kind);
            writer.WriteIntValue("limit", Limit);
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57MetricsResults>("metricsResults", MetricsResults);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative57WarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
