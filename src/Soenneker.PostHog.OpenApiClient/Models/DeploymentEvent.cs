...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class DeploymentEvent : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The deployment this event belongs to.</summary>
        public Guid? Deployment { get; private set; }
        /// <summary>Event category, e.g. `status_changed`, `preview_captured`, `dispatched`.</summary>
...
#nullable restore
        ...
        public string EventType { get; set; }
#endif
        /// <summary>Unique identifier for the event row.</summary>
        public Guid? Id { get; private set; }
        /// <summary>When the event occurred (server time).</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.DeploymentEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.DeploymentEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.DeploymentEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "deployment", n => { Deployment = n.GetGuidValue(); } },
