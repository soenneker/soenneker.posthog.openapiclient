...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class EventMetadataPropertyFilter : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter.EventMetadataPropertyFilter_value? Value { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter.EventMetadataPropertyFilter_value Value { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter();
        }
        /// <summary>
        ...
        public partial class EventMetadataPropertyFilter_value : IComposedTypeWrapper, IParsable
        {
            ...
            /// <summary>Composed type representation for type List&lt;global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter_valueMember1&gt;</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter.EventMetadataPropertyFilter_value"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter.EventMetadataPropertyFilter_value CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter.EventMetadataPropertyFilter_value();
                ...
                else if(parseNode.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter_valueMember1>(global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter_valueMember1.CreateFromDiscriminatorValue)?.AsList() is List<global::Soenneker.PostHog.OpenApiClient.Models.EventMetadataPropertyFilter_valueMember1> eventMetadataPropertyFilterValueMember1Value)
                {
