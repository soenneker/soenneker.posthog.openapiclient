...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class TraceSpansQueryResponse : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseResults? Results { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseResults Results { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseWarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseWarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "results", n => { Results = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseResults>(global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseResults.CreateFromDiscriminatorValue); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseWarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseWarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseResults>("results", Results);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.TraceSpansQueryResponseWarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
