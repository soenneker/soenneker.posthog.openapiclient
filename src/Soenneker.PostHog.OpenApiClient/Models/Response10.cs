...
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Response10ColumnsItem>? Columns { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Response10ColumnsItem> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.Response10Results? Results { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.Response10Results Results { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Response10TypesItem>? Types { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Response10TypesItem> Types { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Response10WarningsItem>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.Response10WarningsItem> Warnings { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Response10ColumnsItem>(global::Soenneker.PostHog.OpenApiClient.Models.Response10ColumnsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "results", n => { Results = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.Response10Results>(global::Soenneker.PostHog.OpenApiClient.Models.Response10Results.CreateFromDiscriminatorValue); } },
                ...
                { "types", n => { Types = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Response10TypesItem>(global::Soenneker.PostHog.OpenApiClient.Models.Response10TypesItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Response10WarningsItem>(global::Soenneker.PostHog.OpenApiClient.Models.Response10WarningsItem.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Response10ColumnsItem>("columns", Columns);
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.Response10Results>("results", Results);
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryTiming>("timings", Timings);
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Response10TypesItem>("types", Types);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.Response10WarningsItem>("warnings", Warnings);
        }
    }
}
