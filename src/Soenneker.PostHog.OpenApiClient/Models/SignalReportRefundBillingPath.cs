...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class SignalReportRefundBillingPath : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public SignalReportRefundBillingPath()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.SignalReportRefundBillingPath"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.SignalReportRefundBillingPath CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.SignalReportRefundBillingPath();
        }
        /// <summary>
