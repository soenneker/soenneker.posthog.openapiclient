...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class LifecycleQueryResponse : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseResultsItemProperty>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseResultsItemProperty> Results { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseWarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseWarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "results", n => { Results = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseResultsItemProperty>(global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseResultsItemProperty.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseWarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseWarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseResultsItemProperty>("results", Results);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.LifecycleQueryResponseWarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
