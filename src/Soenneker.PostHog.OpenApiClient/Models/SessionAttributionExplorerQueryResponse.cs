...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class SessionAttributionExplorerQueryResponse : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The columns property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseColumnsItem>? Columns { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseColumnsItem> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseResults? Results { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseResults Results { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseTypesItem>? Types { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseTypesItem> Types { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseWarningsItem>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseWarningsItem> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseColumnsItem>(global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseColumnsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "results", n => { Results = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseResults>(global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseResults.CreateFromDiscriminatorValue); } },
                ...
                { "types", n => { Types = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseTypesItem>(global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseTypesItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseWarningsItem>(global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseWarningsItem.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseColumnsItem>("columns", Columns);
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseResults>("results", Results);
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryTiming>("timings", Timings);
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseTypesItem>("types", Types);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.SessionAttributionExplorerQueryResponseWarningsItem>("warnings", Warnings);
        }
    }
}
