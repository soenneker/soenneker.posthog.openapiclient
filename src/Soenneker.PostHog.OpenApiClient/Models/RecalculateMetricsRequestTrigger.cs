...
{
    /// <summary>
    /// What triggered this recalculation (manual is the default for user-initiated runs)* `manual` - Manual* `agent_mcp` - Agent (MCP)* `cold_run` - Cold Run* `stale_refresh` - Stale Refresh* `auto_refresh` - Auto Refresh* `config_change` - Config Change* `experiment_launch` - Experiment Launch* `experiment_stop` - Experiment Stop* `experiment_update` - Experiment Update
    /// </summary>
    ...
    public partial class RecalculateMetricsRequestTrigger : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public RecalculateMetricsRequestTrigger()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.RecalculateMetricsRequestTrigger"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.RecalculateMetricsRequestTrigger CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.RecalculateMetricsRequestTrigger();
        }
        /// <summary>
