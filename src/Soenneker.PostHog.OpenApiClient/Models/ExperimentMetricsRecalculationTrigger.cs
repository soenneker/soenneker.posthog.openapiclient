...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class ExperimentMetricsRecalculationTrigger : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public ExperimentMetricsRecalculationTrigger()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.ExperimentMetricsRecalculationTrigger"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.ExperimentMetricsRecalculationTrigger CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.ExperimentMetricsRecalculationTrigger();
        }
        /// <summary>
