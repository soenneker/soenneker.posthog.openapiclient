...
{
    /// <summary>
    /// The default AI run selection stored at team or user level.Write payload for the tasks config endpoints and the `ai_run_preferences` block oftheir responses. What a complete selection is depends on the harness: an ACP defaultsets `runtime_adapter` and `model` together, a Pi default sets `model` alone. Sendevery field as null to clear a stored preference.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class TasksAiRunPreferences : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Models.TasksAiRunPreferences"/> and sets the default values.
        /// </summary>
        public TasksAiRunPreferences()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.TasksAiRunPreferences"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.TasksAiRunPreferences CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.TasksAiRunPreferences();
        }
        /// <summary>
