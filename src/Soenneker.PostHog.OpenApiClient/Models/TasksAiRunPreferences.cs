...
{
    /// <summary>
    /// The default AI run triple stored at team or user level.Write payload for the tasks config endpoints and the `ai_run_preferences` block oftheir responses. `runtime_adapter` and `model` must be set together; send all threeas null to clear a stored preference.
    /// </summary>
