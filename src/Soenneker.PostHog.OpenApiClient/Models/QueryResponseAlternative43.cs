...
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ColumnsItem>? Columns { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ColumnsItem> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.WebAnalyticsPreComputeStrategyWrapper8? PreComputeStrategy { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.WebAnalyticsPreComputeStrategyWrapper8 PreComputeStrategy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ResultsItem>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ResultsItem> Results { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43TypesItem>? Types { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43TypesItem> Types { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43WarningsItem>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43WarningsItem> Warnings { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ColumnsItem>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ColumnsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "preComputeStrategy", n => { PreComputeStrategy = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.WebAnalyticsPreComputeStrategyWrapper8>(global::Soenneker.PostHog.OpenApiClient.Models.WebAnalyticsPreComputeStrategyWrapper8.CreateFromDiscriminatorValue); } },
                ...
                { "results", n => { Results = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ResultsItem>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ResultsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "types", n => { Types = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43TypesItem>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43TypesItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43WarningsItem>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43WarningsItem.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ColumnsItem>("columns", Columns);
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.WebAnalyticsPreComputeStrategyWrapper8>("preComputeStrategy", PreComputeStrategy);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43ResultsItem>("results", Results);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43TypesItem>("types", Types);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative43WarningsItem>("warnings", Warnings);
        }
    }
}
