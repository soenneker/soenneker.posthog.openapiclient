...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class MarketingAnalyticsAttributionPathsQueryResponse : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Conversions with at least one in-window touchpoint. The share denominator — deliberately unfiltered by min/maxTouchpoints so shares stay comparable across filter values.</summary>
        public int? AttributedConversions { get; set; }
        /// <summary>The attribution window actually used, for the tooltips.</summary>
...
#nullable restore
        ...
        /// <summary>Whether the goal is revenue-bearing, which gates the value column.</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathRow>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathRow> Results { get; set; }
#endif
...
#nullable restore
        ...
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryTiming> Timings { get; set; }
#endif
        /// <summary>All conversions in range, before the touchpoint-count filter.</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponseWarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponseWarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attributedConversions", n => { AttributedConversions = n.GetIntValue(); } },
                ...
                { "results", n => { Results = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathRow>(global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponseWarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponseWarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteIntValue("attributedConversions", AttributedConversions);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathRow>("results", Results);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MarketingAnalyticsAttributionPathsQueryResponseWarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
