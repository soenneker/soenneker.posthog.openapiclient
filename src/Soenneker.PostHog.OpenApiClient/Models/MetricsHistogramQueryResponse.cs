...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class MetricsHistogramQueryResponse : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Upper bound per row (y axis), ascending.</summary>
...
#nullable restore
        ...
        public List<double?> Bounds { get; set; }
#endif
        /// <summary>Observation count per cell: counts[row][column], row = bound, column = time.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public UntypedNode? Counts { get; set; }
#nullable restore
#else
        public UntypedNode Counts { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseResults? Results { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseResults Results { get; set; }
#endif
        /// <summary>Bucket start per column (x axis), ISO 8601, ascending.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseWarningsItem>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseWarningsItem> Warnings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "counts", n => { Counts = n.GetObjectValue<UntypedNode>(UntypedNode.CreateFromDiscriminatorValue); } },
                ...
                { "results", n => { Results = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseResults>(global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseResults.CreateFromDiscriminatorValue); } },
                { "times", n => { Times = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseWarningsItem>(global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseWarningsItem.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<UntypedNode>("counts", Counts);
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseResults>("results", Results);
            writer.WriteCollectionOfPrimitiveValues<string>("times", Times);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.MetricsHistogramQueryResponseWarningsItem>("warnings", Warnings);
        }
    }
}
