...
namespace Soenneker.PostHog.OpenApiClient.Models
{
    ...
    public partial class WebPageURLSearchQuery : IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_properties>? Properties { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_properties> Properties { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery();
        }
        /// <summary>
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WebPageURLSearchQuery_conversionGoal : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            public global::Soenneker.PostHog.OpenApiClient.Models.CustomEventConversionGoal CustomEventConversionGoal { get; set; }
#endif
            /// <summary>Composed type representation for type <see cref="global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery_conversionGoalMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery_conversionGoalMember1? WebPageURLSearchQueryConversionGoalMember1 { get; set; }
#nullable restore
#else
            public global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery_conversionGoalMember1 WebPageURLSearchQueryConversionGoalMember1 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_conversionGoal"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_conversionGoal CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_conversionGoal();
                ...
                result.WebPageURLSearchQueryConversionGoalMember1 = new global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery_conversionGoalMember1();
                return result;
            }
            /// <summary>
            /// The deserialization information for the current model
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(ActionConversionGoal != null || CustomEventConversionGoal != null || WebPageURLSearchQueryConversionGoalMember1 != null)
                {
                    return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(ActionConversionGoal, CustomEventConversionGoal, WebPageURLSearchQueryConversionGoalMember1);
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            {
                if(ReferenceEquals(writer, null)) throw new ArgumentNullException(nameof(writer));
                writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.ActionConversionGoal>(null, ActionConversionGoal, CustomEventConversionGoal, WebPageURLSearchQueryConversionGoalMember1);
            }
        }
        /// <summary>
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WebPageURLSearchQuery_properties : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_properties"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_properties CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.PostHog.OpenApiClient.Models.WebPageURLSearchQuery.WebPageURLSearchQuery_properties();
