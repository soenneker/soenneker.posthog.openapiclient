...
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36ColumnsItem>? Columns { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36ColumnsItem> Columns { get; set; }
#endif
...
#nullable restore
        ...
        public int? MissingActorsCount { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36Types? Types { get; set; }
#nullable restore
#else
        public global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36Types Types { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36WarningsAnyOf1Item>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36WarningsAnyOf1Item> Warnings { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36ColumnsItem>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36ColumnsItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "error", n => { Error = n.GetStringValue(); } },
                { "hasMore", n => { HasMore = n.GetBoolValue(); } },
                { "hogql", n => { Hogql = n.GetStringValue(); } },
                { "limit", n => { Limit = n.GetIntValue(); } },
                { "missing_actors_count", n => { MissingActorsCount = n.GetIntValue(); } },
                ...
                { "types", n => { Types = n.GetObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36Types>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36Types.CreateFromDiscriminatorValue); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36WarningsAnyOf1Item>(global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36WarningsAnyOf1Item.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36ColumnsItem>("columns", Columns);
            writer.WriteStringValue("error", Error);
            writer.WriteBoolValue("hasMore", HasMore);
            writer.WriteStringValue("hogql", Hogql);
            writer.WriteIntValue("limit", Limit);
            writer.WriteIntValue("missing_actors_count", MissingActorsCount);
            ...
            writer.WriteObjectValue<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36Types>("types", Types);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.PostHog.OpenApiClient.Models.QueryResponseAlternative36WarningsAnyOf1Item>("warnings", Warnings);
        }
    }
}
