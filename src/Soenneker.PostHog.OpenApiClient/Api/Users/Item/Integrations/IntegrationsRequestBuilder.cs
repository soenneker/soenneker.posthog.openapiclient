...
namespace Soenneker.PostHog.OpenApiClient.Api.Users.Item.Integrations
{
    ...
    public partial class IntegrationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.PostHog.OpenApiClient.Api.Users.Item.Integrations.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Users.Item.Integrations.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public IntegrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/users/{user_%2Did}/integrations", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Users.Item.Integrations.IntegrationsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IntegrationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/users/{user_%2Did}/integrations", rawUrl)
        {
        }
    }
}
