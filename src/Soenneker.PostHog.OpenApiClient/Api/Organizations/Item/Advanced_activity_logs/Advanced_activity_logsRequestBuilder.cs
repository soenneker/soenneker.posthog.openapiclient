...
using Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Available_filters;
using Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Export;
...
using System;
namespace Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs
{
    /// <summary>
    /// Builds and executes requests for operations under \api\organizations\{-id}\advanced_activity_logs
    /// </summary>
    ...
    public partial class Advanced_activity_logsRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Available_filters.Available_filtersRequestBuilder Available_filters
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Available_filters.Available_filtersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The export property</summary>
        [Obsolete("")]
        public global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Export.ExportRequestBuilder Export
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Export.ExportRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Advanced_activity_logsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/organizations/{%2Did}/advanced_activity_logs{?activities*,clients*,detail_filters*,end_date*,follow*,hogql_filter*,include_values*,ip_addresses*,is_system*,item_ids*,ordering*,page*,page_size*,schema*,scopes*,search_text*,start_date*,team_ids*,users*,was_impersonated*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Advanced_activity_logsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/organizations/{%2Did}/advanced_activity_logs{?activities*,clients*,detail_filters*,end_date*,follow*,hogql_filter*,include_values*,ip_addresses*,is_system*,item_ids*,ordering*,page*,page_size*,schema*,scopes*,search_text*,start_date*,team_ids*,users*,was_impersonated*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder.Advanced_activity_logsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder.Advanced_activity_logsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.PostHog.OpenApiClient.Api.Organizations.Item.Advanced_activity_logs.Advanced_activity_logsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Organization-wide view of activity logs across every project in the organization.Mounted at /api/organizations/&lt;organization_id&gt;/advanced_activity_logs/.Restricted to organization admins and owners.
        /// </summary>
...
#nullable restore
            ...
            public global::Soenneker.PostHog.OpenApiClient.Models.OrgOrganizationsAdvancedActivityLogsListOrderingParameter? Ordering { get; set; }
