...
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Error_tracking.Symbol_sets
{
    ...
    public partial class Symbol_setsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Symbol_setsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{project_id}/error_tracking/symbol_sets", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Error_tracking.Symbol_sets.Symbol_setsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Symbol_setsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{project_id}/error_tracking/symbol_sets", rawUrl)
        {
        }
    }
}
