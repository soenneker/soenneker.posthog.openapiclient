...
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Saved
{
    ...
    public partial class SavedRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Saved.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Saved.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public SavedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{project_id}/saved", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Saved.SavedRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SavedRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{project_id}/saved", rawUrl)
        {
        }
    }
}
