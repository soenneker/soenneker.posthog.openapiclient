...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\projects\{projectId}\property_definitions\bulk_update_tags
    /// </summary>
    ...
    public partial class Bulk_update_tagsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Bulk_update_tagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{projectId}/property_definitions/bulk_update_tags", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Property_definitions.Bulk_update_tags.Bulk_update_tagsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Bulk_update_tagsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{projectId}/property_definitions/bulk_update_tags", rawUrl)
        {
        }
        /// <summary>
