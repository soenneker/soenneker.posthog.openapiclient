...
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Persons.Item.Delete_property
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Persons.Item.Delete_property.Delete_propertyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Persons.Item.Delete_property.Delete_propertyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Persons.Item.Delete_property.Delete_propertyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Persons.Item.Delete_property.Delete_propertyRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This endpoint is meant for reading and deleting persons. To create or update persons, we recommend using the [capture API](https://posthog.com/docs/api/capture), the `$set` and `$unset` [properties](https://posthog.com/docs/product-analytics/user-properties), or one of our SDKs.
        /// </summary>
