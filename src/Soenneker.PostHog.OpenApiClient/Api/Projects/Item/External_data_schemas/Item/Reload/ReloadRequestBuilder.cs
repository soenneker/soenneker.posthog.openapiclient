...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\projects\{projectId}\external_data_schemas\{id}\reload
    /// </summary>
    ...
    public partial class ReloadRequestBuilder : BaseRequestBuilder
    {
        ...
        public ReloadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{projectId}/external_data_schemas/{id}/reload", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.External_data_schemas.Item.Reload.ReloadRequestBuilder"/> and sets the default values.
