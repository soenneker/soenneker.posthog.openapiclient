...
using Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Item;
...
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists
{
    ...
    public partial class Session_recording_playlistsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.PaginatedSessionRecordingPlaylistList?> GetAsync(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder.Session_recording_playlistsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.PaginatedSessionRecordingPlaylistList> GetAsync(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder.Session_recording_playlistsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder.Session_recording_playlistsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder.Session_recording_playlistsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Session_recording_playlists.Session_recording_playlistsRequestBuilder WithUrl(string rawUrl)
        {
