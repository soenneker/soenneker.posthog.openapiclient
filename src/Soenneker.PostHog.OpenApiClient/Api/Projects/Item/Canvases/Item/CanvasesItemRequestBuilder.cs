...
using System;
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \api\projects\{projectId}\canvases\{id}
    /// </summary>
    ...
    public partial class CanvasesItemRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Draft.DraftRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The drafts property</summary>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Drafts.DraftsRequestBuilder Drafts
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Drafts.DraftsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Promote.PromoteRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The publish property</summary>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Publish.PublishRequestBuilder Publish
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Publish.PublishRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The publishCurrentVersion property</summary>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.PublishCurrentVersion.PublishCurrentVersionRequestBuilder PublishCurrentVersion
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.PublishCurrentVersion.PublishCurrentVersionRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Request_fix.Request_fixRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The revert property</summary>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Revert.RevertRequestBuilder Revert
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Revert.RevertRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.Validate.ValidateRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public CanvasesItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{projectId}/canvases/{id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.CanvasesItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CanvasesItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{projectId}/canvases/{id}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.Canvas?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.Canvas> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.Canvas?> PatchAsync(global::Soenneker.PostHog.OpenApiClient.Models.PatchedCanvasUpdate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.Canvas> PatchAsync(global::Soenneker.PostHog.OpenApiClient.Models.PatchedCanvasUpdate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Soenneker.PostHog.OpenApiClient.Models.PatchedCanvasUpdate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Soenneker.PostHog.OpenApiClient.Models.PatchedCanvasUpdate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.CanvasesItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Canvases.Item.CanvasesItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
