...
#nullable enable
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.Dashboard?> PostAsync(global::Soenneker.PostHog.OpenApiClient.Models.CopyDashboardTileRequest body, Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Dashboards.Item.Copy_tile.Copy_tileRequestBuilder.Copy_tileRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.Dashboard> PostAsync(global::Soenneker.PostHog.OpenApiClient.Models.CopyDashboardTileRequest body, Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Dashboards.Item.Copy_tile.Copy_tileRequestBuilder.Copy_tileRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.PostHog.OpenApiClient.Models.CopyDashboardTileRequest body, Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Dashboards.Item.Copy_tile.Copy_tileRequestBuilder.Copy_tileRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.PostHog.OpenApiClient.Models.CopyDashboardTileRequest body, Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Dashboards.Item.Copy_tile.Copy_tileRequestBuilder.Copy_tileRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Dashboards.Item.Copy_tile.Copy_tileRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Dashboards.Item.Copy_tile.Copy_tileRequestBuilder WithUrl(string rawUrl)
        {
