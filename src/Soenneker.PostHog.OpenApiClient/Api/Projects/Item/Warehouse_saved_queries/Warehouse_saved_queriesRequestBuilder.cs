...
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries
{
    ...
    public partial class Warehouse_saved_queriesRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Resume_schedules.Resume_schedulesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Soenneker.PostHog.OpenApiClient.api.projects.item.warehouse_saved_queries.item collection</summary>
        ...
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Item.Warehouse_saved_queriesItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Item.Warehouse_saved_queriesItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Models.PaginatedDataWarehouseSavedQueryMinimalList"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.PaginatedDataWarehouseSavedQueryMinimalList?> GetAsync(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder.Warehouse_saved_queriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.PostHog.OpenApiClient.Models.PaginatedDataWarehouseSavedQueryMinimalList> GetAsync(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder.Warehouse_saved_queriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.PostHog.OpenApiClient.Models.PaginatedDataWarehouseSavedQueryMinimalList>(requestInfo, global::Soenneker.PostHog.OpenApiClient.Models.PaginatedDataWarehouseSavedQueryMinimalList.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create, Read, Update and Delete Warehouse Tables.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder.Warehouse_saved_queriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder.Warehouse_saved_queriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Warehouse_saved_queries.Warehouse_saved_queriesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Create, Read, Update and Delete Warehouse Tables.
        /// </summary>
