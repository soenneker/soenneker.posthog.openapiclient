...
{
    /// <summary>
    /// Builds and executes requests for operations under \api\projects\{projectId}\integrations\{id}\email\verify
    /// </summary>
    ...
    public partial class VerifyRequestBuilder : BaseRequestBuilder
    {
        ...
        public VerifyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{projectId}/integrations/{id}/email/verify", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.Integrations.Item.Email.Verify.VerifyRequestBuilder"/> and sets the default values.
