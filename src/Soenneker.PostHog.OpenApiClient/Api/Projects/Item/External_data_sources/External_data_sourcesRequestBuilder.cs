...
namespace Soenneker.PostHog.OpenApiClient.Api.Projects.Item.External_data_sources
{
    ...
    public partial class External_data_sourcesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.External_data_sources.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.External_data_sources.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public External_data_sourcesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{project_id}/external_data_sources", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.PostHog.OpenApiClient.Api.Projects.Item.External_data_sources.External_data_sourcesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public External_data_sourcesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/projects/{project_id}/external_data_sources", rawUrl)
        {
        }
    }
}
